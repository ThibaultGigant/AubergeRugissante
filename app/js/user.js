...
function onAskGagner()
{
	...
	end += "Vous avez pu braver les tréfonds des gouffres les plus tumultueux, passant par moments du bon temps. " + strAttaque + strDefense + "\nDe plus, votre sens du jugement " +
